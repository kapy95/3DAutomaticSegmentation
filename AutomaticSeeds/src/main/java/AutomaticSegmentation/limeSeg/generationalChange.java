...
public class generationalChange {
	...
	public void main(ArrayList<Individuo> population, int nextPopulationSize) {
		...
		while(this.nextGeneration.size()<nextPopulationSize-1) {
			...
			if(counterMutated==maxCrossover) {//if the maximum percentage of indiviuals generated by crossover has been reached, the rest of individuals will be generated by mutation
		...
		//if selectedMethod1 is equal to 1 and if the maximum amount of individuals created by crossover is lower than 85% of the new populationsize, the new individual will be created by crossover:
			if(selectedMethod1==1 && maxCrossover>counterCrossover) {
				...
				if(selectedMethodI1==1) {//if it is equal to 1, rouletteWheelSelection will be chosen as selection method 
					...
					selectedIndividual1=this.tournamentSelection(population, 4);
				}
			...
			}else if (maxMutated>counterMutated){//if the maximum amout of individuals generated by mutation has not been reached, the individual will be generated only by mutation:
				...
				if(selectedMethod2==1) {//it is equal to 1 rouletteWheelSelection will be chosen as selection method 
					...
					selectedIndividual=this.tournamentSelection(population, 4);
				}
