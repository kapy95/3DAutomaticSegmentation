...
public class WGPUBlockList extends GPUBlockList{    
    ...
    public WGPUBlockList(Optimizer op) {
        super();
    ...
    void computeCenters(GPUDots gDots, int gpuBlockSize) {
        ...
        Pointer kernelParameters = Pointer.to(
                    // Dots properties
                    Pointer.to(gDots.iGA_Float[this.gpudots.PX].gpuArray), 
                    Pointer.to(gDots.iGA_Float[this.gpudots.PY].gpuArray),
                    Pointer.to(gDots.iGA_Float[this.gpudots.PZ].gpuArray),
                    // Blocks Properties
        ...
        cuCtxSynchronize();
        cuLaunchKernel(this.opt.fAVGBlocks, 
    ...
    void computeDirFurthestPoint(GPUDots gDots, int gpuBlockSize) {
        ...
        cuCtxSynchronize();
        cuLaunchKernel(this.opt.fKDTree_FindFurthestBlocks, 
                           nGPUBlocks,  1, 1,             // Grid dimension 
                           gpuBlockSize, 1, 1,      // Block dimension
    ...
    public void mapDotsIntoNewBlocksAndGetRank(GPUDots gDots, int gpuBlockSize, float limitInteractAttract) {
        ...
        Pointer kernelParameters = Pointer.to(
                    ...
                    Pointer.to(gDots.iGA_Float[this.gpudots.PY].gpuArray),
                    Pointer.to(gDots.iGA_Float[this.gpudots.PZ].gpuArray),
                    Pointer.to(gDots.iGA_Float[this.gpudots.SUPER_DOT_RADIUS_SQUARED].gpuArray), // necessary for the mapping
        ...
        cuCtxSynchronize();
        cuLaunchKernel(this.opt.fMapDots, 
                           nGPUBlocks,  1, 1,             // Grid dimension 
                           gpuBlockSize, 1, 1,      // Block dimension
    ...
    public void dispatchBlocks(GPUDots gDots, 
        ...
        cuCtxSynchronize();
        cuLaunchKernel(this.opt.fSortBlocks, 
                           nGPUBlocksRequired,  1, 1,             // Grid dimension 
                           gpuBlockSize, 1, 1,      // Block dimension
                           0, null,                         // Shared memory size and stream 
                           kernelParameters, null                      // Kernel- and extra parameters
        ...
        cuCtxSynchronize();
        cuLaunchKernel(this.opt.fDispatchDots, 
                           nGPUBlocks,  1, 1,             // Grid dimension 
                           gpuBlockSize, 1, 1,      // Block dimension
