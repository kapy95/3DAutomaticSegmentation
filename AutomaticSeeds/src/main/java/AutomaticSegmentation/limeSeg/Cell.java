...
import AutomaticSegmentation.limeSeg.*;
...
public class Cell {
     ...
     */
    public ArrayList<Cell> cellTs = new ArrayList<>();                       
    
    /**
     *  counter to generate new cell identifiers
     */
    public  int idCell = 0;                   
     ...
     */
    public Cell(int channel_, LimeSeg lms) {     
