...
public class DotnAdapted extends DotN implements Cloneable {    
     ...
     */
    public ArrayList<DotnAdapted> dotsContained=null;
    /**
     ...
     * @param N_in
     */
    public DotnAdapted(Vector3D pos_in, Vector3D N_in) {
        pos=pos_in;
        Norm=N_in;
        Norm.normalize();
     ...
     */
    public DotnAdapted generate(float d_0) {
        ...
        DotnAdapted nd_new = new DotnAdapted(p_new,n_new);
        nd_new.ct=this.ct;
